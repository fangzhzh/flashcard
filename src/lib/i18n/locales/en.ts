...
export default {
  ...
  'task.form.label.flashcardId': 'Flashcard ID',
  'task.form.placeholder.flashcardId': 'Enter Flashcard ID',
  'task.form.error.artifactLink.flashcardIdRequired': 'Flashcard ID is required.',
  'task.form.label.urlValue': 'URL',
  'task.form.placeholder.urlValue': 'https://example.com',
  'task.form.error.artifactLink.urlRequired': 'URL is required.',
