...
export default {
  ...
  'task.form.error.artifactLink.multipleLinks': "Cannot link both a flashcard and a URL. Please choose one or remove one.",
  ...
  'task.form.artifactLink.button.removeLink': 'Remove Link',
  ...
  'toast.task.flashcardLinked': 'New flashcard created and linked to task.',
  ...
  'task.display.label.tomorrowShort': '2mr',
  'task.display.at': 'at',
