...
export default {
  ...
  'task.form.label.flashcardId': '抽认卡 ID',
  'task.form.placeholder.flashcardId': '输入抽认卡 ID',
  'task.form.error.artifactLink.flashcardIdRequired': '需要抽认卡 ID。',
  'task.form.label.urlValue': 'URL',
  'task.form.placeholder.urlValue': 'https://example.com',
  'task.form.error.artifactLink.urlRequired': '需要 URL。',
