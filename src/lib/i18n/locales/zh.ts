...
export default {
  ...
  'task.form.artifactLink.sectionTitle': '工件链接',
  ...
  'task.form.label.urlValue': 'URL',
  'task.form.placeholder.urlValue': 'https://example.com',
  'task.form.error.artifactLink.invalidUrl': 'URL 格式无效。',
  'task.form.error.artifactLink.multipleLinks': "不能同时链接抽认卡和URL。请选择一个或移除一个。",
